 ...
 * \param [in] instream_matrix The stream should be of size ((param_N * 2) * 4) bytes.
 * \param [out] outstream_matrixOut The stream should be of size ((param_N * 2) * 4) bytes.
 */
void Vectors(
	int32_t param_N,
	const uint32_t *instream_matrix,
	uint32_t *outstream_matrixOut);
...
typedef struct { 
	...
	const uint32_t *instream_matrix; /**<  [in] The stream should be of size ((param_N * 2) * 4) bytes. */
	uint32_t *outstream_matrixOut; /**<  [out] The stream should be of size ((param_N * 2) * 4) bytes. */
} Vectors_actions_t;
